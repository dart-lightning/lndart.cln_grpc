...
Welcome in the HACKING guide and how a day in a lndart.cln_grpc maintainer looks like.
...
The commit style is one of the more important concept to manage a monorepo like lndart.clightning, and in particular
...
- Generate the changelog related to the package:
    ...
    - `make {changelog_client|changelog_flutter|changelog}`, where
        - `changelog_rpc`: generate the changelog for clightning_rpc;
        - `changelog_plugin`: generate the changelog for cln_plugin;
